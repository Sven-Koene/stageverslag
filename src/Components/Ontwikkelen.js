                        ...
                        <div className="text">
                            <TabContent for="Simplicate">
                                <div className="content">
                                    ...
                                    <ul>
                                        <li>Binnen de particles heb je een invulveld om bijvoorbeeld je HTML code in te vullen. Dit is geen editor en vertelt ook niet of er fouten in de code zitten.</li>
                                        <li>Het scherm voor de code is klein waardoor je geen overzicht kan houden over wat je intypt. Een oplossing is om alles in een editor te maken en vervolgens te kopiëren en plakken in het venster. Dit vereist wel extra stappen, tijd en geld. Daarnaast ben je wel met stukken code aan het spelen, maar het voelt niet als programmeren. Hierdoor twijfelde ik af en toe wel aan het systeem.</li>
                                    </ul>
                                    ...
                                    <p>In eerste instantie was ik overweldigd door de Simplicate opdracht en dacht ik dat het niet ging lukken om dit positief af te ronden Naar mijn verbazing ging het proces vrij soepel en is het gelukt de pagina na te bouwen. Dit kwam vooral doordat het werken met alle modules en particles vrij makkelijk verliep. Na een aantal keer te moeten zoeken naar modules en particles komt er gewenning en zijn ze makkelijk te vinden. Door een aantal keer te kijken wat de modules en partikels dan doen als je ze aanpast begrijp je ook hoe je ze het best kan gebruiken.</p>
                                    <p>Van dit project heb ik geleerd hoe er binnen IDN wordt geproduceerd en gecommuniceerd. Interne communicatie gaat hier veelal via skype. Dit vind ik vaak onprettig aangezien het ook gebeurt als mensen naast elkaar zitten. Om deze reden heb ik besloten mijn onderzoek te doen naar interne communicatie.</p>
                            ...
                            <TabContent for="Bultersmekke">
                                <div className="content">
                                    ...
                                    <p>De twee dagen voor het nabouwen van Bultersmekke was genoeg, omdat we onze weg in het framework nu wel konden vinden. Met de opgedane kennis konden we nu meewerken aan de echte websites.</p>
                                    <p>Bij de opdrachten van Bultersmekke en Simplicate had ik het niet altijd naar mijn zin. Dit kwam doordat het niet voor een echte klant was maar alleen inwerk projecten waren. Ik wist dat er met het werk verder niks meer ging gebeuren, waardoor het soms nutteloos voelde.</p>
                            ...
                            <TabContent for="Job">
                                <div className="content">
                                    ...
                                    <p>Voor Job Dura Fonds kreeg ik een opdracht vergelijkbaar met de landingspagina van VvE010. Op de website hadden ze een lange lijst met sponsoren en de datum waarop die sponsoren hebben gedoneerd. Dit was een lange pagina zonder enige visuele feedback. Als verbetering hiervoor was bedacht dat het in een tijdlijn gezet kan worden. Aan mij de taak deze tijdlijn te maken.</p>
                                    ...
                                    <p>Wederom liep ik tegen een aantal problemen aan maar aangezien ik vorige keer te veel vragen stelde, besloot ik nu meer initiatief te tonen en zelf eerst meer te proberen. Ook wist ik nu dat niemand het kon zien en ik fouten mocht maken. Allereerst begon ik met het aanmaken van de jaartallen en de content daarin te zetten. De plugin maakt er automatisch een placeholder plaatje bij. Na dit gedaan te hebben kwam ik erachter dat de plugin niet goed was geïnstalleerd waardoor nu meerdere pagina’s die wel zichtbaar waren voor publiek de tijdlijn ook lieten zien. Dit heb ik gelijk nagevraagd bij de developers die dit samen met mij hebben opgelost. Het bleek dat er een optie nog aan stond die uit gezet had moeten worden.</p>
                            ...
                            <TabContent for="stageverslag">
                                <div className="content">
                                    ...
                                    <p>Ik ben gaan kijken naar andere mogelijkheden en kwam uit op React. React is momenteel populair en veel klasgenoten hebben hier al een portfolio in gemaakt, dus ik wist al een beetje hoe het in elkaar stak. Elke week heb ik de vrijdagmiddag ingepland om aan mijn stageverslag te werken. Een deel van deze tijd heb ik gebruikt om mezelf React aan te leren. Mijn eerste React site is voor het stageverslag dat je nu leest. Een vervolgstap is het bouwen van een portfolio in React die ik kan gebruiken voor het vinden van mijn afstudeerstage.</p>
                                </div>
                            </TabContent>
                            <TabContent for="responsive">
                                <div className="content">
                                    ...
                                    <p>Na het maken van dit testplan ben ik samen met een andere stagiair de tests gaan doorlopen. Er zaten nog veel bugs in die wij vaak zelf konden oplossen, maar ook genoeg waar we hulp voor moesten inschakelen. De volgende link verwijst naar het document met daarin het testplan met de uitslagen.</p>
                                    ...
                                    <p>Doordat het maken van het testplan en het testen zo goed ging, ben ik naarmate de stage vorderde vaak gevraagd een website te testen. Dit ging dan om responsiveness, maar ook het vinden van bugs. Elke test leidde tot nieuwe iteraties en verbeterde websites.</p>
                                    <p>Door het maken van dit testplan en het uitvoeren van de test ben ik me meer bewust geworden van hoe moeilijk het kan zijn een website responsive te maken. Ook verschilt het soms per laptop of de fout ook echt fout is. Ik heb geleerd te testen in verschillende browser versies. Een aantal keer heb ik een website getest waar ik geen fouten in kon vinden. Ik merkte dat ik dit frustrerend vond omdat het dan voelde alsof ik de test tijd had verspild, terwijl het wel belangrijk is om tests te blijven uitvoeren. Naarmate de tijd vorderde heb ik hier ook minder last van gehad. Binnen de bijlage is het nog niet altijd duidelijk te zien waar op de pagina iets fout is. Voor een volgende keer ga ik kijken of ik het template iets anders kan maken zodat dit duidelijker wordt. Nu kwam het voor dat de developer de fouten ging oplossen die ik zelf niet kon oplossen of met vragen naar me toe kwam omdat het niet duidelijk was wat er fout was.</p>
                                </div>
                            </TabContent>
                            <TabContent for="tekenbeet">
                            <div className="content">
                                <h3>Stichting Tekenbeetziekten</h3>
                                <p>Voor het ontwerp van de nieuwe website voor stichting Tekenbeetziekten ben ik ook met iteraties bezig geweest. Als eerste iteratie heb ik een wireframe gemaakt en ben deze vervolgens steeds verder gaan uitbreiden tot een echt ontwerp. Kijk voor een uitgebreide omschrijving bij het kopje ontwerpen onder het tabje Tekenbeetziekten.</p>
                            </div>
                            </TabContent>
                        </div>
                    </Tabs>
