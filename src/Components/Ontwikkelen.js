...
class Ontwikkelen extends React.Component{
                        ...
                        <div className="text">
                            <TabContent for="Simplicate">
                                <div className="content">
                                    ...
                                    <p>Aan het begin van mijn stage kreeg ik de opdracht om de website van Simplicate na te bouwen met de frameworks van het bedrijf. Simplicate is een concurrerend bedrijf die ook CRM (customer relationship management) systemen aanbiedt. 
    Op deze manier zou ik me beter kunnen navigeren binnen het CMS en op niveau komen van de andere developers zodat ik mee kan werken op de manier die zij ook gewend zijn. Een belangrijk ding wat me toen gevraagd is, is om dingen op te schrijven waarvan ik dacht dat het beter kon of onhandig was.
                                    ...
                                    <ul>
                                        ...
                                        <li>Het scherm voor de code is klein waardoor je geen overzicht kan houden over wat je intypt</li>
                                        <li>Een oplossing is om alles in een editor te maken en vervolgens te kopiëren en plakken in het venster. Dit vereist wel extra stappen, tijd en dus ook geld.</li>
                                        <li>Daarnaast ben je wel met stukken code aan het spelen, maar het voelt niet als programmeren. Hierdoor twijfelde ik af en toe wel aan het systeem.</li>
                                    </ul>
                            ...
                            <TabContent for="Bultersmekke">
                                <div className="content">
                                    ...
                                    <p>De twee dagen voor het nabouwen van Bultersmekke waren meer dan genoeg, omdat we onze weg in het framework nu wel konden. Met de opgedane kennis konden we nu meewerken aan de echte websites.</p>
                            ...
                            <TabContent for="VvE010">
                                <div className="content">
                                    ...
                                    <p>Voor een volgende keer weet ik dat ik iets zekerder kan zijn voor de dingen die ik doe en dat er ruimte is voor fouten. Dit soort projecten staan verborgen online waardoor het niet erg als het niet in één keer goed gaat, omdat gebruikers het niet kunnen zien. Vragen blijf ik stellen tot ik helemaal zeker ben van mijn zaak. Ik vond het heel fijn dat zo een project werd toevertrouwd aan een stagiair. Dit toont aan dat het bedrijf vertrouwen heeft in de stagiairs.</p>
...
Ik ben gaan zoeken naar oplossingen hiervoor maar kwam er al snel achter dat dit niet praktisch was. Het advies wat ik heb gegeven is om toch gewoon gebruik te maken van iDeal, omdat er dan ook minder fout kan gaan met de bestelling.</p>
                            ...
                            <TabContent for="responsive">
                                <div className="content">
                                    ...
                                    <p>De test in de bijlage begint met een onderzoek naar welke browsers er het meest worden gebruikt op PC, tablet, en telefoon. Zo kunnen de testen gericht worden uitgevoerd in de juiste browsers.
                                    Vervolgens staat er een uitleg over de test en hoe de test template in elkaar zit. De template is onderverdeeld in de verschillende devices met een sub-titel voor de verschillende pagina’s van de geteste websites. 
                                    Als laatst staat het template en de testresultaten in de bijlage. Een groot probleem bleek de ondersteuning voor Internet Explorer. De websites zagen er vaak goed uit in chrome en firefox maar alles ging kapot in internet explorer omdat bepaalde functies binnen gantry niet werken binnen internet explorer.
                                    </p>
                                    <p>Doordat het maken van het testplan en het testen zo goed ging, zijn wij naarmate de stage vorderde vaak gevraagd een website te testen. Dit ging dan om responsiveness, maar ook het vinden van bugs. Elke test leidde tot nieuwe iteraties en verbeterde websites. 
                                    </p>
