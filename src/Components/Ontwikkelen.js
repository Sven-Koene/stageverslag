                        ...
                        <div className="text">
                            ...
                            <TabContent for="VvE010">
                                <div className="content">
                                    ...
                                    <p>Voor een volgende keer weet ik dat ik iets zekerder kan zijn voor de dingen die ik doe en dat er ruimte is voor fouten. Dit soort projecten staan verborgen online waardoor het niet erg is als het niet in één keer goed gaat, omdat gebruikers het niet kunnen zien. Vragen blijf ik stellen tot ik helemaal zeker ben van mijn zaak. Ik vond het fijn dat zo’n project werd toevertrouwd aan een stagiair. Dit toont aan dat het bedrijf vertrouwen heeft in de stagiairs.</p>
                            ...
                            <TabContent for="Job">
                                <div className="content">
                                    ...
                                    <p>Wederom liep ik tegen een aantal problemen aan maar aangezien ik vorige keer iets te veel vragen stelde, besloot ik nu meer initiatief te tonen en zelf eerst iets meer te proberen. Ook wist ik nu dat niemand het kon zien en ik fouten mocht maken. Allereerst begon ik gewoon met het aanmaken van de jaartallen en de content daarin te zetten. De plugin maakt er automatisch een placeholder plaatje bij. Na dit gedaan te hebben kwam ik erachter dat de plugin niet goed was geïnstalleerd waardoor nu meerdere pagina’s die wel zichtbaar waren voor publiek de tijdlijn ook lieten zien. Dit heb ik gelijk nagevraagd bij de developers die dit samen met mij hebben opgelost. Het bleek dat er een optie nog aan stond die uit gezet had moeten worden.</p>
