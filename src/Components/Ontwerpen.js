                        ...
                        <div className="text">
                            ...
                            <TabContent for="Persona">
                                <div className="content">
                                    ...
                                    <p>Iets wat ik wel vaak zonder nadenken deed is foto’s van het internet pakken en gebruiken. Tijdens mijn stage heb ik veel geleerd over de regels omtrent privacy en het gebruik van iemand anders zijn werk. Hieronder vallen bijvoorbeeld: teksten, foto’s, en logo’s. Om ook daar rekening mee te houden heb ik alleen foto’s gebruikt in de persona die komen van Pixabay. Dit is een website waar je gratis foto’s van kan gebruiken.</p>
                            ...
                            <div className="content">
                                    ...
                                    <p>Ik heb de opdracht gekregen om een nieuwe website te maken voor stichting Tekenbeetziekten. Momenteel is de website verouderd en toe aan een update. De website had twee grote navigatiebalken met daarin nog grote dropdown menu’s. Veel van de pagina’s bevatte maar weinig content en konden makkelijk worden gecombineerd. Daarom heb ik met behulp van Adobe XD een wireframe gemaakt met daarin de gecombineerde pagina’s. Hieronder het resultaat in een screenshot.</p>
                                    <img src={tekenframes} alt="wireframes stichting tekenbeetziekten" className="singleImage"></img>
                                    <p>Na het maken van de wireframes ben ik begonnen aan een ontwerp voor de homepage. Dit ging niet meteen goed omdat ik te veel vast hield aan de originele pagina. Bij mijn eerste feedback moment kreeg ik dan ook een grote lijst feedback waardoor het hele ontwerp is omgegooid. Het vernieuwde ontwerp bevat meer visuals en minder tekst. Er is beter nagedacht over het kleurgebruik en de site heeft over het algemeen een betere sfeer.</p>     
                            ...
                            <div className="content">
                                    <h3>Stageverslag</h3>
                                    <p>Om mijn competenties aan te vullen heb ik besloten in plaats van een verslag te schrijven, een website te bouwen als bewijs voor mijn stage competenties. Aangezien deze website gebouwd zal worden tijdens stage uren mag ik hier ook competenties mee invullen.</p>
