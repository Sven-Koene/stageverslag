                        ...
                        <div className="text">
                            <TabContent for="infographic">
                                <div className="content">
                                    ...
                                    <p>Na het vragen van feedback bleek mijn eerste poging was te kinderlijk omdat ik geen rekening had gehouden met de doelgroep; leraren en ouders van kinderen die studeren op een van de opleidingen van stichting Fioretti Teylingen.</p>
                            ...
                            <div className="content">
                                    ...
                                    <p>Mijn interesse ligt het meest bij Front-end ontwerpen besloot ik eerst een wireframe te maken. Na een klein onderzoek naar webdesign trends besloot ik te gaan voor een minimalistisch strak ontwerp. Weinig kleuren in het vaste ontwerp zorgt voor rust en wat mysterie. In de foto hieronder zie je wat ik ervan heb gemaakt. Het logo van IDN moet hierin nog worden vervangen door een persoonlijk logo.</p>
