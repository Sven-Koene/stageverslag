                        ...
                        <div className="text">
                            <TabContent for="STARR individueel">
                                <div className="content">
                                    ...
                                    <p><b>Resultaat</b></p>
                                    <p>Het resultaat is een mooi ontwerp dat kan worden voorgelegd aan de stichting. Helaas had de stichting geen tijd meer voor het einde van mijn stage om te reageren. Het iteratief werken werkt goed omdat je steeds verder komt in je ontwerp en slechte punten van vorige iteraties kan verbeteren in het nieuwe ontwerp.</p>
                                    <p><b>Reflectie</b></p>
                            ...
                            <TabContent for="STARR teamverband">
                                <div className="content">
                                    ...
                                    <p><b>Situatie</b></p>
                                    <p>RotterdamDuurzaam is een initiatief opgezet door IDN. Aan het begin was het aan mij om individueel verbeterpunten voor de website te zoeken om deze nieuw leven in te blazen. Dit project werd al snel een team project waarin ik meerdere rollen heb gespeeld. Van ons werd verwacht dat we met ideeën kwamen die de website nieuw leven in zouden blazen.</p>
                                    <p><b>Taak</b></p>
                                    <p>Een aantal verschillende rollen die ik op me heb genomen zijn: ontwerper en onderzoeker. Als ontwerper heb ik de visuals voor social media gemaakt en geholpen bij het maken van een nieuw design voor RotterdamDuurzaam. Als onderzoekers hebben we veel onderzoek moeten doen naar bijvoorbeeld de content die mensen aantrekt, de beste tijd om te posten of welke initiatieven we aan de website kunnen toevoegen.</p>
                                    <p><b>Actie</b></p>
                                    <p>We zijn begonnen met het bekijken van het verbeterpuntendocument dat ik eerder al had gemaakt en we zijn hier dingen aan gaan toevoegen. De website werd niet groen gehost en dat was het eerste punt dat we wilden oplossen. Vervolgens zijn we gaan brainstormen om andere manieren te bedenken om meer mensen naar de website te trekken. Onze hoofd ideeën: social media actief posten, nieuwe initiatieven zoeken en op zoek gaan naar leuke acties. Dit hebben we zo gedaan, omdat dat voor veel andere bedrijven ook werkt om ze bekendheid te geven.</p>
                                    <p><b>Resultaat</b></p>
                                    <p>Het behaalde resultaat was dat vooral op social media meer bekendheid is gekomen en er initiatieven waren die ons contacteerden om ook op de website te komen. We hebben met onze acties wel een aantal nieuwe gebruikers gegenereerd maar niet veel. Dit komt mogelijk doordat de website nog in een verouderde staat is en er niet aantrekkelijk uitziet voor het publiek.</p>
                                    <p><b>Reflectie</b></p>
                                    <p>Volgende keer zou ik vragen om meer hulp. Nu hebben we met zijn drieën alles moeten doen en heeft er vooral veel tijd gezeten in het schrijven van social media posts. Dit valt niet binnen mijn competenties, waardoor ik denk dat ik deze tijd ook beter had kunnen besteden. Het werk binnen het team verliep goed. De teamleden hebben een betere band met elkaar opgebouwd waardoor het werk ook makkelijker verliep. Van de hele situatie heb ik wel inzichten gekregen over hoe je een website of bedrijf op de kaart kan zetten met gebruik van social media.</p>
                                    <img></img>
                                </div>
                            </TabContent>
                            ...
                            <TabContent for="Gouda Geo website">
                                <div className="content">
                                    ...
                                    <p>Gouda-Geo is een andere klant van IDN waarvan het project al lang stil stond. Door ons succes met Beaudermo werd ons gevraagd om te kijken of onze techniek ook werkt op Gouda-Geo. Gouda-Geo is een bedrijf dat instrumenten verkoopt voor grondwerk en grondonderzoek. Het project was in eerste instantie op stil gezet, omdat de communicatie slecht verlopen was en er geen content naar IDN werd doorgestuurd. Wij denken dat dit mede komt door het lange verwarrende contract dat wordt opgesteld aan het begin van een project. Ook voor Gouda-Geo was er al een nieuw template gekozen die nog moest worden ingevuld. Wederom hebben we vragen opgesteld en zijn we gaan bellen. Op de website van Gouda-Geo staan veel verschillende gereedschappen. Een van onze vragen was bijvoorbeeld: ’Is er een inventarislijst van het gereedschap? Zodat de lijst met gereedschappen kan worden geüpdatet’. Andere vragen gingen over de layout. Bijvoorbeeld of de contactpagina en ‘over ons’-pagina gescheiden moesten worden.</p>
