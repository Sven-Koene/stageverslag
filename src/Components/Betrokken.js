                    ...
                    <Tabs>
                        ...
                        <TabContent for="feedback">
                            ...
                            <div className="content">
                                    ...
                                    <p>Helaas was de evenementenkalender op de website nog wel leeg. Eerst ben ik zelf de initiatieven af gegaan die al op RotterdamDuurzaam.nl stonden maar hier kwam weinig uit. Ook omdat de goedkeuring tot posten te lang duurden, waren de events die ik wel had gevonden vaak al verouderd. Om de kalender toch een beetje te vullen heb ik het idee geopperd om bijvoorbeeld kerst in de kalender te zetten met daarbij bijvoorbeeld een lijstje met 5 manieren om een duurzame kerst te vieren. Dit werd goedgekeurd en is op de evenementenkalender gezet.</p>
