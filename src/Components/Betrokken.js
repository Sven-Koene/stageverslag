                    ...
                    <Tabs>
                        ...
                        <TabContent for="feedback">
                            <div className="content">
                                    <h3>Feedback</h3>
                                    <p>Tijdens alle projecten die ik heb mogen doen heb ik zoveel mogelijk gevraagd om feedback. Merendeels van de werknemers die daar het meest van wisten, maar vaak ook van andere stagiairs. Deze feedback heb ik vervolgens zo veel en goed mogelijk verwerkt in waar ik mee bezig was. In volgende opdrachten heb ik hier  zoveel mogelijk rekening mee gehouden. Als klein voorbeeld heb ik feedback genoteerd die ik heb gekregen voor het ontwerp van stichting tekenbeetziekten.</p>
                                    <ul>
                            ...
                            <div className="content">
                                    ...
                                    <p>Samen met één andere stagiair ben ik gaan zoeken naar Dit soort stichtingen die wel een website upgrade kunnen gebruiken. Samen hebben we een lijst gemaakt met 100 stichtingen en voor iedere stichting ook de redenen waarom de site geüpdatet moet worden en hoe. Deze lijst hebben we voorgelegd aan de stichtingen met daarbij de keuze om het door ons te laten doen voor een verlaagd tarief of er iets anders mee te doen. Het klantencontact is gedaan door het sales team. Er zijn eerst mails gestuurd om te kijken of hier antwoord op kwam. Als de mails onbeantwoord bleven, is er gebeld om het te vragen.</p>
                                    <p>Het doel van dit kansenonderzoek was de stichtingen meer bekendheid geven en daarmee misschien meer donaties en vrijwilligers genereren. Natuurlijk was een bijzaak ook nieuwe klanten genereren voor IDN.</p>
                                    <p>We hoopten uit de lijst met 100 stichtingen ongeveer tien nieuwe projecten te halen. Uiteindelijk zijn hier drie klanten en één potentiële klant uitgekomen.. Het grootste probleem is dat er vaak geen budget is om het uit te besteden en IDN niet bereid was het voor minder te doen dan het al verlaagde Stichtingen tarief. Met dit onderzoek hoopte ik meer klanten te genereren om daarmee ook een deel van de betrokken competentie te behalen. Maar drie stichtingen een betere bekendheid geven met een nieuwe website vond ik niet genoeg. Daarom ben ik samen met de andere stagiair gaan werken aan RotterdamDuurzaam.nl</p>
                            ...
                            <div className="content">
                                    ...
                                    <p>Helaas was de evenementenkalender op de website nog wel leeg. Eerst ben ik zelf de initiatieven af gegaan die al op RotterdamDuurzaam.nl stonden maar hier kwam weinig uit. Ook omdat de goedkeuring tot posten te lang duurden, waren de events die ik wel had gevonden vaak al verouderd.
                                    Om de kalender toch een beetje te vullen heb ik het idee geopperd om bijvoorbeeld kerst in de kalender te zetten met daarbij bijvoorbeeld een lijstje met 5 manieren om een duurzame kerst te vieren. Dit werd goed gekeurd en is op de evenementenkalender gezet.. 
                                    </p>
                                    <p>Verder was er het idee om een soort nieuwsbrief te sturen naar de initiatieven met de vraag of zij nog leuke events hadden die in de kalender konden worden gezet. Na een dag kregen we antwoord van Floating Farm, Een duurzaam initiatief die zuivel producten produceert op een drijvende boerderij in rotterdam. Zij organiseerden een kerstmarkt op de boerderij en wilden graag op de social media en in de kalender van RotterdamDuurzaam worden genoemd.</p>
