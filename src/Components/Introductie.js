       ...
       return(
            <Grid
                ...
                <div className="content">
                    <p>Tijdens mijn zoektocht naar een stageplek dacht ik dat het heel makkelijk zou zijn een stageplek te vinden. Dit was echter niet zo, er waren een paar problemen. Ik wist nog niet welke richting ik op wilde. Hierdoor bleven er nog zoveel mogelijke stagebedrijven over, dat ik niet wist waar ik moest beginnen. Ik wilde eerst mijn propedeuse halen en een portfolio website maken voordat ik ging zoeken, wat het zoeken al uitstelde. Door omstandigheden is de portfolio website nooit gemaakt en was ik nog meer tijd kwijt.</p>
                    ...
                    <p>Eigenlijk was er geen plek voor meer stagiairs, maar ze wilden wel een uitzondering maken. Dit betekende wel dat ik minder stagevergoeding zou krijgen. Op dat moment dacht ik daar niet zo over na en was ik alleen al blij dat ik een stage had gevonden. </p>
                    <p>Binnen IDN heb ik de vrijheid gekregen uit te vinden waarin ik me meer wil specialiseren. Door een beetje van alles te doen, ben ik erachter gekomen wat ik leuken minder leuk vond. Soms deed de feedback dan ook wel pijn. Bijvoorbeeld als ik ergens trots op was en het totaal niet bleek te zijn wat er gevraagd werd. Een voorbeeld hiervan is bijvoorbeeld bij de eerste opdracht. Ik had simplicate nagebouwd en het zag er goed uit. Het was alleen totaal niet zoals ze het binnen het bedrijf zouden doen en dus eigenlijk niet goed. Een ander voorbeeld is  de feedback op mijn eindbeoordeling.</p>
                    <p>Tijdens mijn stage heb ik meer interesse gekregen in het leren van React en dit ben ik mijzelf ook gaan aanleren.</p>
                    <p>Een tip voor iedereen die opzoek moet naar een stage. Begin op tijd met zoeken. Hoe later je begint hoe minder keuze je hebt en hoe meer stress het oplevert. Ook kan het gebeuren dat je dan in een bedrijf terecht komt waar je stage raar kan verlopen en bijvoorbeeld zoals bij mij je stagebegeleider niet genoeg aanwezig is om je echt goed te begeleiden.</p>
                </div>
                </div>
            </Grid>
       )
