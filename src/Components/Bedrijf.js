            ...
            <div className="text">
                <TabContent for="IDN">
                    <div className="content">
                                     <h3>Werkzaamheden</h3>
                                     <p>Internetdiensten Nederland(“in het vervolg” IDN) is een bedrijf dat zich bezig houd met alle werkzaamheden rondom internet. Als “full service internetbureau” is IDN instaat om (bijna) alle internetgerelateerde diensten voor de klant te verzorgen.
                            ...
                            <TabContent for="bedrijfsbezoek">
                                <div className="content">
                                    ...
                                    <p>Bij binnenkomst hebben we een klein gesprekje gehouden met de begeleider wat een goede indruk gaf van het bedrijf. Daarna zijn we in een vergaderruimte gaan zitten waar Lotte haar werk heeft laten zien en meer heeft verteld over haar stage. De animaties zagen er mooi uit en dit heeft mij zeker inspiratie gegeven voor dingen die ik ook graag zou willen kunnen.</p>
                                    <h3>Redkiwi</h3>
