                    ...
                    <div className="content">
                            ...
                            <TabContent for="bedrijfsbezoek">
                                <div className="content">
                                    ...
                                    <p>Om een indruk te krijgen van andere stagebedrijven zijn we met een groep van zeven studenten langs gegaan bij een aantal stage bedrijven. De bedoeling hiervan is om te kijken hoe de stage er bij de andere aan toe gaat. Er was ruimte om vragen te stellen over het bedrijf en de projecten.</p>
                                    <h3>DotControl</h3>
                                    <p>Het eerste bedrijf dat we bezochten was DotControl. Door de bedrijfssafari in het eerste en tweede jaar was ik hier al twee keer geweest, dus wist ik al hoe het bedrijf eruit zag en wat ze deden. Martijn en Nienke lopen hier stage en ik hoorde veel positieve verhalen over het bedrijf.</p>
                                    <p>Bij binnenkomst sta je in een grote bedrijfshal met een donkere en industriële sfeer. Met een aantal wanden is de grote hal opgedeeld in een aantal secties waar verschillende delen van het bedrijf zitten.</p>
                                    <p>Tijdens het gesprek met de stagebegeleider van Dotcontrol begon het te regenen. Doordat een deel van het dak van plastic platen is gemaakt maakte dit een veel herrie. Door de grootte van het bedrijf en de herrie veroorzaakt door de werknemers, het weer en de meeuwen die het dak aanvallen was ik niet enthousiast over een stage bij Dotcontrol.</p>
                                    <h3>Rodesk</h3>
                                    ...
                                    <h3>Redkiwi</h3>
                                    <p>Volgende bedrijf op de lijst was Redkiwi. Hier loopt Janessa stage op de afdeling DevOps. Wederom een groot open office. Eerst hebben we een uitleg gekregen van de stagebegeleider, die me een beetje deed denken aan programmeer leraar Bob. Na de uitleg van de begeleider hebben we nog een rondleiding gekregen van Janessa en heeft ze laten zien wat voor werk ze onder andere uitvoert op stage. Ik had persoonlijk nog nooit eerder van de term DevOps gehoord dus wist ik niet wat ik me hier bij voor moest stellen.</p>
                            ...
                            <TabContent for="reflectie">
                                <div className="content">
                                    ...
                                    <p><b>Eigen reflectie: </b>Het klopt dat ik moeilijke situaties wel wat weg lach. Dit is een ding waar ik al langere tijd aan werk en steeds minder wordt. Ik heb het idee dat ik binnen deze stage veel zelfstandiger ben geworden dus hierop zou ik graag uitleg hebben gevraagd. De urenregistratie is inderdaad niet goed bijgehouden, omdat dit vanuit mijzelf is gekomen en niet is aangegeven door het bedrijf.</p>
                                </div>
                            </TabContent>
                        </div>
                    </Tabs>
