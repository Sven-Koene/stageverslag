                    ...
                    <div className="content">
                            ...
                            <TabContent for="bedrijfsbezoek">
                                <div className="content">
                                    ...
                                    <p>Om een indruk te krijgen van andere stagebedrijven zijn we met een groepje van 7 studenten langs gegaan bij een aantal stage bedrijven. De bedoeling hiervan is om te kijken hoe de stage er bij de andere aan toe gaat. Er was ruimte om vragen te stellen over het bedrijf en de projecten.</p>
                                    <h3>DotControl</h3>
                                    <p>Het eerste bedrijf dat we bezochten was DotControl. Door de bedrijfssafari in het eerste en 2e jaar was ik hier al 2 keer geweest dus wist ik al een beetje hoe het bedrijf eruit zag en wat ze deden. Martijn en Nienke lopen hier stage en ik hoorde veel positieve verhalen het bedrijf.</p>
                                    ...
                                    <h3>Rodesk</h3>
                                    <p>Het tweede bedrijf waar we lang gingen was Rodesk. Voor mij was dit een compleet nieuw bedrijf. Lotte liep hier stage en specialiseert zich hier vooral in het maken van animaties. Het bedrijf is relatief klein. Bij binnenkomst kom je binnen in een modern ingerichte sfeervolle ruimte met veel licht en een uitzicht over het Rotterdamse water.</p>
                                    <p>Bij binnenkomst hebben we een klein gesprekje gehouden met de begeleider wat een goeie indruk gaf van het bedrijf. Daarna zijn we in een vergaderruimte gaan zitten waar Lotte haar werk heeft laten zien en meer heeft verteld over haar stage. De animaties zagen er mooi uit en dit heeft mij zeker inspiratie gegeven voor dingen die ik ook graag zou willen kunnen.</p>
                                    <h3>Redkiwi</h3>
                                    <p>Volgende bedrijf op de lijst was Redkiwi. Hier loopt Janessa stage op de afdeling Devops. Wederom een heel groot open office. Eerst hebben we een uitleg gekregen van de stagebegeleider die me een beetje deed denken aan programmeerleraar Bob. Na de uitleg van de begeleider hebben we nog een rondleiding gekregen van Janessa en heeft ze laten zien wat voor werkk ze onder andere uitvoert op stage. Ik had persoonlijk nog nooit eerder van de term devops gehoord dus wist niet wat ik me hierbij voor moest stellen.</p>
                                    ...
                                    <p>We zijn Door Jordy over de verschillende afdelingen rondgeleid. Het bedrijf is heel groot en verspreid over verschillende  verdiepingen. Elke afdeling heeft zijn eigen naam waardoor ik een beetje kwijt was waar het allemaal over ging. Na de rondleiding heeft Jordy zijn werk nog laten zien en was er ruimte voor wat vragen. Einde van de dag was iedereen een beetje moe dus veel vragen waren er niet meer.
                                    </p><p>]
Mijn eerste indruk van Connect Holland is door de rommeligheid niet heel goed. Het bedrijf is groot en verwarrend en door het rommelige bezoek was er weinig duidelijkheid. Wel was het weer een goeie indruk van een ander soort bedrijf.
</p>
                                </div>
                            </TabContent>
                            <TabContent for="reflectie">
                                <div className="content">
                                    ...
                                    <p>Allereerst de uren. De discussie over de niet behaalde uren heb ik niet kunnen winnen. Mijn stagebegeleider vind werken aan je stageverslag niet vallen binnen de stage uren en geloofde niet dat ik de vrijdagen thuis ook echt had gewerkt. Daarnaast was hij het niet eens met de werktijden die ik had ingevuld op mijn urenverantwoording. Als feedback op de gemiste uren stond er: Niet gehaald, circa 100 uur te weinig. Ik ben mijn loonstroken na gaan kijken en op mijn laatste loonstrook stond dat ik ben betaald voor totaal 520 werkuren. Mijn eerste maand stage heb ik geen vergoeding gekregen. Mijn eerste maand heb ik drie weken van 40 uur stage gelopen. Dit komt uit op een totaal van 120 uur in de eerste maand plus 520 in drie opvolgende maanden is 640 uur totaal.
                                    In het tweede deel van de e-mail krijg ik het idee dat de beoordeling niet is ingevuld op mijn werkzaamheden maar op de “slordige en eigenzinnige afronding”</p>
                                    <br></br>
                                    ...
                                    <p><b>Eigen reflectie: </b>in de feedback wordt gezegt dat ik een paar maanden nodig had om op gang te komen. Mijn stage duurde echter maar 4 maanden. In het vervolg moet ik beter communiceren over wat ik heb gedaan zodat ik de begeleiders ook laat zien dat het niet een paar maanden zijn maar een paar weken of dagen.</p>
                                    <p><b>Ontwerpen</b></p>
                                    <p><b>Conceptualiseren: </b>Enigzinszins gezien, moet wel aangereikt worden.</p>
                                    <p><b>Ontwerpen en prototypen: </b>Enigzinszins gezien, moet wel aangereikt worden.</p>
                                    <p><b>Eigen reflectie: </b>Aan deze feedback heb ik niks. Aan het begin heb ik ontwerp opdrachten gekregen en aangegeven dat ik het soms moeilijk vind ontwerpen te maken. Ik denk dat het deel moet wel aangereikt worden hierop gericht is. In een gesprek zou ik dit graag uitgebreider uitgelegd hebben gekregen. Ondanks ik het ontwerpen soms moeilijk vond heb ik me hier wel sterk in ontwikkeld.</p>
                                    <p><b>Ondernemen</b></p>
                                    <p><b>Ondernemende houding en vaardigheren:</b> Weinig ondernemende houding, Sven laat het gebeuren en loopt regelmatig achter de feiten aan. Weet als laatste waar zijn stage aan moet voldoen, houd zich te vaak wat van de ontwetende.</p>
                                    ...
                                    <p><b>Eigen reflectie: </b>Dat dit niet tot zijn uiting is gekomen zou kunnen komen omdat ik vaak begeleiding heb gekregen van andere binnen het bedrijf. Mijn stagebegeleider kwam bijna elke dag pas rond 12 uur binnen en is een aantal keer ook eerder vertrokken. Hierdoor ben ik vaak om opdrachten en feedback gaan vragen bij andere werknemers.</p>
                                    <p>Het maakt mij boos dat in de feedback wordt gezegd dat ik zelf heb aangegeven dat ik me niet bezig houd met maatschappelijke verantwoordelijkheid. Dit is niet waar. Ik ben met mijn projecten vaak bezig geweest met de maatschappelijke verantwoording. Mede omdat ik het een moeilijke competentie vond om in te vullen.</p>
                                    <p><b>Sterke punten</b></p>
                                    <p>Sven is behulpzaam en assiteert goed mee in een afgebakende takenset. Sven kan zich breed ontwikkelen, van basis-techniek tot aan content maken.</p>
                                    <p><b>Verbeterpunten</b></p>
                                    <p>Sven kan werken aan heldere communicatie, hij blijft vaak wat in het midden en lacht wat weg waardoor het moeilijker is te zien wat hij kan en denkt. Wellicht kan hij meer dan hij laat zien. Sven moet wel op gang geholpen worden, een proactievere adviserende houding zou passen bij een HBO student. Technisch vakmanschap is wat bijgespijkerd tijdens zijn stage, dat nog goed doorzetten zou zijn bijdrage sterker maken. Meer zelfstandigheid, moest wel eens op gang gehouden worden. Betere en transparantere  urenregistratie en oplossingsgericht overleg op basis van argumenten als daar iets mis in lijkt te gaan.</p>
